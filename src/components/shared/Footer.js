    ...
    return (
        <div className={styles.Footer}>
            <div className={styles.FooterContent}>
                <div id="social" className={`flex justify-end pt-10 pb-10 border-b-1 border-blue-900 ${styles.SocialLinks}`}>
                    <a 
                ...
                {/* left aligned company oinfo */}

                <div id="company-info" className="relative pt-10 pb-10  text-left">
