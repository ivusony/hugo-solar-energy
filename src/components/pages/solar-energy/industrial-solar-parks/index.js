                ...
                >
                    <div className="paragraph-icon mb-5">
                        <svg height="50px" width="50px"  viewBox="0 0 512 512"  >
                            <g>
                                <path className="fill-[var(--color-secondary)]" d="M386.234,78.954l-49.861,49.861l4.635,4.814c-3.302,2.667-6.644,5.269-9.888,7.579
...
export default function IndustrialSolarParks() {
    let { locale } = useRouter();
    let locales = useLocales();
            ...
            >
                ...
                >
                    ...
                    <a href="/contact" className="text-[var(--color-secondary)] font-medium text-xl">
                        { locales[locale].industrial_solar_parks.contact_button }
                    </a>
