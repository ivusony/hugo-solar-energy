    ...
    return(
        ...
        >
            <motion.div
                ...
                variants={item}
            >
                <h2 className="hugo-h2">{locales[locale].our_services.EndMessageSegment.title}</h2>
            </motion.div>
            ...
            <motion.div
                ...
                variants={item}
            >
                <p className="max-w-3xl mx-auto hugo-p-justify">{ findCompanyTitleAndMakeLink(locales[locale].our_services.EndMessageSegment.text) }</p>
            </motion.div>
