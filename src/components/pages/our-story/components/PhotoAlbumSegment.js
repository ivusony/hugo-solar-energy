            ...
            >
                ...
                >
                    <motion.div
                        key={1}
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-2 lg:row-span-2 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/271320940_216268384030310_7574279993870886393_n.jpg")}
                    >
                        <Image 
                    ...
                    <motion.div
                        key={2}
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-1 lg:row-span-2 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/472854418_907201771603631_7846606760671888800_n.jpg")}
                    >
                    ...
                    <motion.div
                        key={3}
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-3 lg:row-span-1 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/473785699_911935471130261_7930744259815660623_n.jpg")}
                    >
                    ...
                    <motion.div
                        key={4}
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-2 lg:row-span-1 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/473827252_913923077598167_6854558647904744990_n.jpg")}
                    >
                    ...
                    <motion.div
                        key={5}
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-1 lg:row-span-1 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/473830692_913925327597942_7200871566735558232_n.jpg")}
                    >
                    ...
                    <motion.div
                        ...
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-2 lg:row-span-2 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/474076236_913922317598243_7066227179784908746_n.jpg")}
                    >
                    ...
                    <motion.div
                        key={7}
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-3 lg:row-span-2 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/474102530_911937331130075_6218670754637931029_n.jpg")}
                    >
                    ...
                    <motion.div
                        ...
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-1 lg:row-span-2 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/474187556_913270557663419_8634686522112193964_n.jpg")}
                    >
                    ...
                    <motion.div
                        ...
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-2 lg:row-span-2 overflow-hidden group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/474200461_913925297597945_4959367417502590941_n.jpg")}
                    >
                    ...
                    <motion.div
                        ...
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-2 lg:row-span-2 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/474743537_917069923950149_5326844373437376252_n.jpg")}
                    >
                    ...
                    <motion.div
                        ...
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-2 lg:row-span-2 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/474839101_917064703950671_7890360416961252650_n.jpg")}
                    >
                    ...
                    <motion.div
                        ...
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-3 lg:row-span-1 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/474848589_917063427284132_6677838867187520471_n.jpg")}
                    >
                    ...
                    <motion.div
                        ...
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-1 lg:row-span-2 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/474848589_917064450617363_8652054819307302733_n.jpg")}
                    >
                    ...
                    <motion.div
                        ...
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-2 lg:row-span-2 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/475014456_918274763829665_1832375321642508183_n.jpg")}
                    >
                    ...
                    <motion.div
                        ...
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-2 lg:row-span-2 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/475020855_917063243950817_685033283842699995_n.jpg")}
                    >
                    ...
                    <motion.div
                        ...
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-1 lg:row-span-1 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/475165750_918307070493101_8852064783053605151_n.jpg")}
                    >
                    ...
                    <motion.div
                        key={17}
                        variants={item}
                        className="col-span-1 row-span-1 sm:col-span-1 sm:row-span-2 lg:col-span-4 lg:row-span-1 overflow-hidden  group relative cursor-pointer"
                        onClick={() => openModal("/assets/images/team/475186311_917739020549906_6360469510207479429_n.jpg")}
                    >
        ...
        {selectedImage && (
            ...
            >
                ...
                >
                    ...
                    <button
                        onClick={closeModal}
                        className="absolute top-4 right-4 bg-black/70 text-white rounded-full w-10 h-10 flex items-center justify-center text-2xl"
                    >
                    &times;
                    </button>
                </div>
